...
# input_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/Top Down Approach/Code/All-in-One/Input/'
# output_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/Top Down Approach/Code/All-in-One/Output/CSV/'
# output_figure_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/Top Down Approach/Code/All-in-One/Output/Figure/'
# process_data(input_path, output_path)

def process_data(input_path, output_path, output_figure_path):
    ''' Floor Area Estimation '''
    # Import assumption to estimate FA
    FA_variable = pd.read_csv(input_path + 'Input variables.csv', skiprows=1)
    ...
    FA_data_2018 = pd.read_csv(input_path + 'Input Floor Area 2018.csv', skiprows=1)
    ...
    FA_data_2020 = pd.read_csv(input_path + 'Input Floor Area 2020.csv', skiprows=1)
    ...
    FA_data_2040 = pd.read_csv(input_path + 'Input Floor Area 2040.csv', skiprows=1)
    ...
    FA_data = merged_df
    FA_data.to_csv(output_path + 'Floor Area.csv', index=False)
    ...
    # Emission Factor
    EF_data = pd.read_csv(input_path + 'Emission Factor.csv')
    ...
    RC_only_Emission_data_annual.to_csv(output_path + 'RC_Only_Emission_Annual.csv', index=True)
    ...
    City_Wide_Emission_data_annual.to_csv(output_path + 'City_Wide_Emission_annual.csv', index=True)


    '''Cost Estimation'''
    # Cost Variable
    Cost_factor = pd.read_csv(input_path + 'Cost Variable.csv')
    ...
    RC_only_Cost_data_annual.to_csv(output_path + 'RC_Only_Cost_annual.csv', index=True)
    ...
    City_Wide_Cost_data_annual.to_csv(output_path + 'City_Wide_Cost_annual.csv', index=True)
   ...
   # Get the current handles and labels from the legend
    ...
    plt.savefig(output_figure_path + 'Emission_Cost_RC.png')
    ...
    plt.savefig(output_figure_path + 'Emission_Cost_City_Wide.png')

    print("Run Successfully")

    
input_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/1st Research/Code/All-in-One/Input/'
output_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/1st Research/Code/All-in-One/Output/CSV/'
output_figure_path = '/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/1st Research/Code/All-in-One/Output/Figure/'
process_data(input_path, output_path, output_figure_path)