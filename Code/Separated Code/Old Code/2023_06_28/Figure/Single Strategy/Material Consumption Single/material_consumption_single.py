...
PC = [2755, 2715, 2671, 2199, 2172, 1899, 1446]
...
PC_AC = [2705, 2665, 2646, 2158, 2132, 1849, 2665]
...
Iron_Steel = [1134, 1118, 1100, 1118, 894, 752, 1118]
...
Wood = [7242, 7136, 7022, 7136, 5709, 8205, 7136]
...
# Set y-axis range of wood graph
axs[1, 1].set_ylim(0, 8700)
axs[1, 1].set_yticks(range(0, 8001, 1000))

# Adjust spacing between subplots
plt.tight_layout()
#plt.show()

plt.savefig('/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/Top Down Approach/Code/Figure/Single Strategy/Material Consumption Single/Material Consumption Single 4.png')
...
# Set y-axis range of wood graph
axs[2].set_ylim(0, 8700)
axs[2].set_yticks(range(0, 8001, 1000))

# Adjust spacing between subplots
plt.tight_layout()


plt.savefig('/Users/akihi/Library/CloudStorage/OneDrive-PrincetonUniversity/Projects/Building Material in Cities/Top Down Approach/Code/Figure/Single Strategy/Material Consumption Single/Material Consumption Single 3.png')
